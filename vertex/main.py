...
async def analyze_document(
    ...
    try:
        ...
        raise HTTPException(
            status_code=419, detail="An error occurred during document analysis."
        )
...
async def ask_question(
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                status_code=419, detail=f"Error loading document: {str(e)}"
            )
        ...
        if results:
            ...
            try:
                ...
                raise HTTPException(
                    status_code=419, detail=f"Error invoking LLMChain: {str(e)}"
                )
            ...
            try:
                ...
                raise HTTPException(
                    status_code=419, detail=f"Error generating embeddings: {str(e)}"
                )
            ...
            try:
                ...
                raise HTTPException(
                    status_code=419, detail=f"Error during similarity search: {str(e)}"
                )
        else:
    ...
    try:
        ...
        response = model.generate_content(
            [
                ...
                Image.load_from_file(wordcloud_positive),
            ],
            safety_settings=safety_settings,
        )
        ...
        response = model.generate_content(
            [
                custom_question + "As a marketing consultant...",
                Image.load_from_file(wordcloud_neutral),
            ],
            safety_settings=safety_settings,
        )
        ...
        response = model.generate_content(
            [
                ...
                Image.load_from_file(wordcloud_negative),
            ],
            safety_settings=safety_settings,
        )
        ...
        for column in selected_data.columns:
            if selected_data[column].dtype == "object":
                ...
                try:
                    ...
                    raise HTTPException(
                        status_code=419, detail=f"Error encoding column {column}: {e}"
                    )
